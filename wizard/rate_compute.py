...
class RateCoputation(models.TransientModel):
    ...
    capital_recovery_dollar_cur = fields.Float(string='Capital recovery($/mw/hr)', required=False,
                                               compute='_capital_recovery_dollar_cur', digits='Ocma')
    capital_recovery = fields.Float(string='Capital recovery(n/mw/hr)', required=False, digits='Ocma' )
    capital_recovery_cur = fields.Float(string='Capital recovery(n/mw/hr)', required=False,
                                        compute='_capital_recovery_cur', digits='Ocma')
    ...
    energy_charge_cur = fields.Float(string='Energy charge(n/mw/hr)', required=False, compute='_energy_charge_cur', digits='Ocma')
    ...
    vfcr = fields.Float(string='VFCR(n/mwh)', required=False, digits='Ocma',)
    vfcr_cur = fields.Float(string='VFCR(n/mwh)', required=False, compute='_vfcr_cur', digits='Ocma',)
    vfcr_dollar = fields.Float(string='VFCR($/mwh)', required=False, digits='Ocma',)
    vfcr_dollar_cur = fields.Float(string='VFCR($/mwh)', required=False, compute='_vfcr_cur_dollar', digits='Ocma',)
    ncpi = fields.Float(string='NCPI(index)', required=False, digits='Ocma',)
    ncpi_cur = fields.Float(string='NCPI(index)', required=False, digits='Ocma',)
    # us_ppi = fields.Float(string='US PPI(Index)', required=False, )
    ...
    investment_naira = fields.Float(string='Investment(n/kw/month)', required=False, compute='_investment_naira', digits='Ocma',)
    general_expenses_naira = fields.Float(string='General Expenses(n/kw/month)', required=False,
                                          compute='_general_expenses_naira', digits='Ocma',)
    insurance_naira = fields.Float(string='Insurance(n/kw/month)', required=False, compute='_insurance_naira', digits='Ocma',)
    fuel_naira = fields.Float(string='Fuel(n/mw/hr)', required=False, compute='_fuel_naira', digits='Ocma',)
    fuel_naira_cur = fields.Float(string='Wholesale charge(n/mw/hr)', required=False, digits='Ocma',)
    tax_cost_cur = fields.Float(string='Tax Cost(n/mw/hr)', required=False, default=974)
    tax_cost = fields.Float(string='Tax cost(n/mw/hr)', required=False, digits='Ocma',)
    capital_cost = fields.Float(string='Capital cost(n/mw/hr)', required=False, digits='Ocma',)
